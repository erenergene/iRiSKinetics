...
addpath(genpath(pwd))
load("BulkSimPastLCalcData.mat") %%CHANGE LOCATION - MOVE BELOW
...
plot(lambda,Refmat_B(:,find(L==esti_L)),'b--','LineWidth',2)
plot(lambda,Refmat_G(:,find(L==esti_L)),'g--','LineWidth',2)
plot(lambda,Refmat_R(:,find(L==esti_L)),'r--','LineWidth',2)
...
plot(lambda,Refmat_B(:,find(L==theoric_L)),'b--','LineWidth',2)
plot(lambda,Refmat_G(:,find(L==theoric_L)),'g--','LineWidth',2)
plot(lambda,Refmat_R(:,find(L==theoric_L)),'r--','LineWidth',2)
...
legend1 = sprintf('B Curves', esti_L);
legend2 = sprintf('G Curves', esti_L);
legend3 = sprintf('R Curves', esti_L);
